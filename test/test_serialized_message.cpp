...
TEST(test_serialized_message, default_initialization) {
  auto serialized_msg = rcutils_get_zero_initialized_serialized_message();

  auto allocator = rcutils_get_default_allocator();
  EXPECT_EQ(RCUTILS_RET_OK, rcutils_serialized_message_init(&serialized_msg, 0, &allocator));
  EXPECT_EQ(0u, serialized_msg.buffer_capacity);
  EXPECT_EQ(RCUTILS_RET_OK, rcutils_serialized_message_fini(&serialized_msg));
  EXPECT_EQ(0u, serialized_msg.buffer_capacity);
...
TEST(test_serialized_message, resize) {
  auto serialized_msg = rcutils_get_zero_initialized_serialized_message();
  auto allocator = rcutils_get_default_allocator();
  auto ret = rcutils_serialized_message_init(&serialized_msg, 5, &allocator);
  ...
  ret = rcutils_serialized_message_resize(&serialized_msg, 11);
  ASSERT_EQ(RCUTILS_RET_OK, ret);
  ...
  ret = rcutils_serialized_message_resize(&serialized_msg, 3);
  ASSERT_EQ(RCUTILS_RET_OK, ret);
